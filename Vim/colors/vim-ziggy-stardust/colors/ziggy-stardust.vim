" Project: Ziggy Stardust Theme
" Repository: TODO
" License: MIT
" Modeled on https://github.com/rakr/vim-one

" Name:    ziggy-stardust colorscheme
...
"   BASIC        HEX                  |      BASIC         HEX                 |
"-------------------------------------|-----------------------------------------
"   Foreground   #d2d8e3              |      Selection     #3e4451             |
"   Background   #292d35              |      Selected Text #d2d8e3             |
"   Bold         #ffffff              |                                        |
"   Links        #aa95ff              |                                        |
"-------------------------------------|-----------------------------------------
...
"-------------------------------------|-----------------------------------------
"   Black        #292d35      0       |      brBlack      #878787      8       |
"   Red          #ff6480      1       |      brRed        #ff78F8      9       |
"   Green        #aada88      2       |      brGreen      #aada88      10      |
"   Yellow       #ff936a      3       |      brYellow     #f7745f      11      |
"   Blue         #71bfff      4       |      brBlue       #8bcdef      12      |
"   Magenta      #7a82da      5       |      brMagenta    #aa95ff      13      |
"   Cyan         #5fb9bc      6       |      brCyan       #5fb9bc      14      |
"   White        #d2d8e3      7       |      brWhite      #d2d8e3      15      |
"-------------------------------------|-----------------------------------------
...
if !exists('g:ziggy_allow_italics')
  let g:ziggy_allow_italics = 0
endif
...
if has('gui_running') || &t_Co == 88 || &t_Co == 256
  ...
  fun <sid>X(group, fg, bg, attr)
    let l:attr = a:attr
    if g:ziggy_allow_italics == 0 && l:attr ==? 'italic'
      let l:attr= 'none'
    endif
...
" Color definition --------------------------------------------------------{{{
  let s:dark = 1
  let s:mono_1 = 'd2d8e3' " fg
  let s:mono_2 = '646c7c'
  let s:mono_3 = '5c6370'
  let s:mono_4 = '4b5263'

  let s:hue_1  = '5fb9bc' " cyan
  let s:hue_2  = '71bfff' " blue
  let s:hue_3  = '7a82da' " purple
  let s:hue_4  = '7a82da' " green

  let s:hue_5   = 'ff6480' " red 1
  let s:hue_5_2 = 'ff78f8' " red 2 (pink)

  let s:hue_6   = 'ff936a' " orange 1
  let s:hue_6_2 = 'f7745f' " orange 2

  let s:syntax_bg     = '292d35'
  let s:syntax_gutter = '636d83'
  let s:syntax_cursor = '2f343a'
  ...
  call <sid>X('jsonSemicolziggyrror',       s:hue_5,   '', 'reverse' )
  " }}}
  ...
  call <sid>X('pythziggyscape',               s:hue_5,     '', '')
...
"}}}
" " Public API --------------------------------------------------------------{{{
" function! ziggy#highlight(group, fg, bg, attr)
